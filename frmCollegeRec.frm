...
Begin VB.Form frmCollegeRec 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "College Register"
   ClientHeight    =   4785
   ClientLeft      =   3435
   ClientTop       =   2580
   ClientWidth     =   6780
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmCollegeRec.frx":0000
      Height          =   1935
      Left            =   120
      TabIndex        =   6
      Top             =   2760
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select COL_NO,COL_NAME from COLLEGE"
      Caption         =   " "
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frmCollegeRec"
